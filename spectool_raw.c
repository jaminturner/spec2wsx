...
void print_current_time_in_ms (void)
{
    ...
    //printf("%d.%09d: ",spec.tv_sec, spec.tv_nsec); //prints full time in sec
    printf("%d%03d: ",spec.tv_sec, spec.tv_nsec/1000000); //ns will be trunc to ms
    return;
}
